<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <String label="Arrival" v-model="value.arrival" :editMode="editMode"/>
            <Date label="DeparttureTime" v-model="value.departtureTime" :editMode="editMode"/>
            <Date label="ArrivalTime" v-model="value.arrivalTime" :editMode="editMode"/>
        </v-card-text>
